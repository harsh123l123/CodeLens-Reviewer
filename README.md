...
- **Monaco Code Editor**: Full-featured VS Code editor engine directly in your browser with syntax highlighting for 15+ languages, line markers, code folding, and minimap.
- **Folder & File Ingestion**: Open entire project directories or upload single files with an interactive project file explorer sidebar.
- **Side-by-Side & Unified Diff Viewer**: Visual comparison showing line additions, deletions, and refactored code with one-click **"Apply Solution"** or **"Apply All Changes"**.
- **Multi-Stage Security & Quality Analysis**:
...
│   ├── database.py               # SQLite persistence for reviews
...
- **Google Gemini Engine**:
  - Add your API key in the `.env` file:
    ...
    ```
  - Or click **Settings** in the Web UI to enter your API key directly.
  - Supports `gemini-3.6-flash`, `gemini-flash-latest`, and `gemini-2.5-pro`.
